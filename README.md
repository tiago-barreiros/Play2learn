...
# Play2learn: I’m really bright

<table>
<tr>
<td>

> A nossa jornada começou pela escolha das funcionalidades que queríamos
implementar na aplicação e como estas poderiam, ou não, influenciar a
experiência do utilizador. A nossa maior preocupação foi criar uma aplicação
acessível e apelativa para a faixa etária à qual a aplicação estava destinada,
alunos do ensino básico. Ao mesmo tempo, queríamos que a aplicação fosse,
igualmente, apelativa a possíveis adultos que quisessem participar junto dos
utilizadores, como o caso dos professores.

> A nossa aplicação, Play2learn, permite o registo de utilizadores na respetiva
plataforma e participar em jogos de perguntas de escolha múltipla em
diversas categorias, alusivas às disciplinas escolares. Adicionalmente, é possível
jogar contra todos os utilizadores registados na aplicação ou criar grupos
privados e jogar contra os amigos.

> Para aliciar a uma nova visita à aplicação por parte dos utilizadores, os resultados
dos jogos são guardados em leaderboards. Estas permitem estimular
o espírito competitivo entre os diversos utilizadores. Além da leaderboards
geral, para todos os utilizadores registados na aplicação, existe uma própria
para cada grupo criado. Este aspeto impulsiona a captação de mais jogadores
para a plataforma, por ser possível a criação de comunidades de amigos que
jogam entre si.

> A aprendizagem ocorre aquando a inicialização do jogo. Outilizador, quando
responde, consegue verificar se deu a resposta certa ou errada. Quando erra a
aplicação indica qual seria a opção correta. Adicionalmente, no fim do jogo,
o utilizador tem a possibilidade de rever o seu jogo, onde consegue ver as perguntas
a que respondeu, assim como as respetivas respostas.
...
[![Java][Java]][Java-url] [![JavaScript][JavaScript]][JavaScript-url] [![Android-Studio][Android-Studio]][Android-Studio-url] [![Firebase][Firebase]][Firebase-url] [![Creately][Creately]][Creately-url] [![Figma][Figma]][Figma-url] [![LaTeX][LaTeX]][LaTeX-url] [![Overleaf][Overleaf]][Overleaf-url]
...
Após a entrega deste projeto ficará público :  https://github.com/Play2learn-PDM
...
### Sistema de Apoio ao Utilizador
...
[![Miguel Marques](https://cdn.discordapp.com/attachments/1050105332891926569/1136342718491148429/Sem_titulo.png)](https://github.com/M1guel11)| [![Tiago Barreiros](https://avatars.githubusercontent.com/u/78179371?s=100&v=4)](https://github.com/tiago-barreiros)
---|----------------------------------------------------------------------------------------------------------------------
[Miguel Marques](https://github.com/M1guel11)|[Tiago Barreiros](https://github.com/tiago-barreiros)
